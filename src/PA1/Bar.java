...
public class Bar {
   ...
   public void draw(Graphics2D g2) {
      ...
      Rectangle2D labelBounds = fontOfLabel.getStringBounds(label, context);
      int widthOfLabel = (int)labelBounds.getWidth();
      int heightOfLabel = (int)labelBounds.getHeight();

      g2.setColor(color.RED);
      g2.drawString(label, left - MIDDLE, bottom+heightOfLabel);

      // draw bar
      int height = (int)(applicationHeight * scale - heightOfLabel);
